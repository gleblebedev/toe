...
namespace Toe.ToeVsExt
{
...

    {
		...
		public EditorPane(ToeVisualStudioExtensionPackage package, string getExtension, Editors.EditorFactory toeEditorFactory)
			: base(null)
		{
			_getExtension = getExtension;
			_toeEditorFactory = toeEditorFactory;
			PrivateInit(package);
		}
		...
		//{
		//    get { 
		//        return 4; //editorControl.TextDocument.DefaultTabStop; 
		//    }
		//    set { 
