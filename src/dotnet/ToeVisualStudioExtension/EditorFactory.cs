...
namespace Toe.ToeVsExt
{
    ...
    /// </summary>
    [Guid(GuidList.guidToeVisualStudioExtensionEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private ToeVisualStudioExtensionPackage editorPackage;
        ...
        public EditorFactory(ToeVisualStudioExtensionPackage package)
        {
			...
			toeEditorFactory = new Editors.EditorFactory();
        }
    	...
    	private Toe.Editors.EditorFactory toeEditorFactory;
        /// <summary>
                        ...
                        out int pgrfCDW)
        {
			...
			EditorPane NewEditor = new EditorPane(editorPackage, Path.GetExtension(pszMkDocument), toeEditorFactory);
