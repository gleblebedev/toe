...
namespace Toe.Editors.Marmalade
{
	public class SkinEditor : UserControl, IView, IBasePathProvider
	{
		...
		public SkinEditor(IEditorEnvironment editorEnvironment, IResourceManager resourceManager, ICommandHistory history)
		{
		...
		private void InitializeEditor()
		{
			...
			var skel = new EditResourceReferenceView(this.editorEnvironment, this.resourceManager, this.history);
			...
			var model = new EditResourceReferenceView(this.editorEnvironment, this.resourceManager, this.history);
			...
			this.animButton = new EditResourceReferenceView(this.editorEnvironment, this.resourceManager, this.history);
