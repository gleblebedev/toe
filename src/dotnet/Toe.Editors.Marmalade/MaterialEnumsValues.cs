...
namespace Toe.Editors.Marmalade
{
	public static class MaterialEnumsValues
	{
		...
		public static EnumWellKnownValues CullModeValues = new EnumWellKnownValues { { CullMode.BACK, new EnumValueOptions("Back") }, { CullMode.FRONT, new EnumValueOptions("Front")}, { CullMode.NONE, new EnumValueOptions("Double sided") } };
