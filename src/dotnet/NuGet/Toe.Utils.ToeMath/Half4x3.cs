...
namespace Toe.Utils.ToeMath
{
	...
	public struct Half4x3: IEquatable<Half4x3>
	{
		...
		/// <summary>
		/// Row 0, Column 1 of the Half4x3.
		/// </summary>
		[FieldOffset(2)]
		public half M01;

		/// <summary>
		/// Row 0, Column 2 of the Half4x3.
		/// </summary>
		[FieldOffset(4)]
		public half M02;
		...
		/// <summary>
		/// Row 1, Column 1 of the Half4x3.
		/// </summary>
		[FieldOffset(8)]
		public half M11;

		/// <summary>
		/// Row 1, Column 2 of the Half4x3.
		/// </summary>
		[FieldOffset(10)]
		public half M12;
		...
		/// <summary>
		/// Row 2, Column 1 of the Half4x3.
		/// </summary>
		[FieldOffset(14)]
		public half M21;

		/// <summary>
		/// Row 2, Column 2 of the Half4x3.
		/// </summary>
		[FieldOffset(16)]
		public half M22;
		...
		/// <summary>
		/// Row 3, Column 1 of the Half4x3.
		/// </summary>
		[FieldOffset(20)]
		public half M31;

		/// <summary>
		/// Row 3, Column 2 of the Half4x3.
		/// </summary>
		[FieldOffset(22)]
		public half M32;
		/// <summary>
		...
		public static bool operator ==(Half4x3 left, Half4x3 right) { return left.Equals(right); }
		public static bool operator !=(Half4x3 left, Half4x3 right) { return !left.Equals(right); }
