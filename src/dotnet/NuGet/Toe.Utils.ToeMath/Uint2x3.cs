...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Uint2x3: IEquatable<Uint2x3>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Uint2x3.
		/// </summary>
		[FieldOffset(0)]
		public uint M00;

		/// <summary>
		/// Row 0, Column 1 of the Uint2x3.
		/// </summary>
		[FieldOffset(4)]
		public uint M01;

		/// <summary>
		/// Row 0, Column 2 of the Uint2x3.
		/// </summary>
		[FieldOffset(8)]
		public uint M02;
		...
		/// <summary>
		/// Row 1, Column 0 of the Uint2x3.
		/// </summary>
		[FieldOffset(12)]
		public uint M10;

		/// <summary>
		/// Row 1, Column 1 of the Uint2x3.
		/// </summary>
		[FieldOffset(16)]
		public uint M11;

		/// <summary>
		/// Row 1, Column 2 of the Uint2x3.
		/// </summary>
		[FieldOffset(20)]
		public uint M12;

		public static readonly Uint2x3 Identity = new Uint2x3(1, 0, 0, 0, 1, 0);
		/// <summary>
		...
		public static bool operator ==(Uint2x3 left, Uint2x3 right) { return left.Equals(right); }
		public static bool operator !=(Uint2x3 left, Uint2x3 right) { return !left.Equals(right); }
