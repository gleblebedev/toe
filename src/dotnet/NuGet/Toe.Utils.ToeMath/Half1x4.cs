...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Half1x4: IEquatable<Half1x4>
	{

		/// <summary>
		/// Constructor of the Half1x4.
		/// </summary>
		public Half1x4(half m00, half m01, half m02, half m03 )
		{
			this.M00 = m00;
			this.M01 = m01;
			this.M02 = m02;
		...
		/// <summary>
		/// Row 0, Column 0 of the Half1x4.
		/// </summary>
		[FieldOffset(0)]
		public half M00;

		/// <summary>
		/// Row 0, Column 1 of the Half1x4.
		/// </summary>
		[FieldOffset(2)]
		public half M01;

		/// <summary>
		/// Row 0, Column 2 of the Half1x4.
		/// </summary>
		[FieldOffset(4)]
		public half M02;

		/// <summary>
		/// Row 0, Column 3 of the Half1x4.
		/// </summary>
		[FieldOffset(6)]
		public half M03;

		public static readonly Half1x4 Identity = new Half1x4(1, 0, 0, 0);
		/// <summary>
		...
		public static bool operator ==(Half1x4 left, Half1x4 right) { return left.Equals(right); }
		public static bool operator !=(Half1x4 left, Half1x4 right) { return !left.Equals(right); }
		...
		public bool Equals(Half1x4 other)
		{
