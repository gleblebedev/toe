...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Half2x2: IEquatable<Half2x2>
	{
		...
		/// <summary>
		/// Constructor of the Half2x2.
		/// </summary>
		public Half2x2(half m00, half m01, half m10, half m11 )
		{
			this.M00 = m00;
			this.M01 = m01;
			this.M10 = m10;
		...
		/// <summary>
		/// Row 0, Column 0 of the Half2x2.
		/// </summary>
		[FieldOffset(0)]
		public half M00;

		/// <summary>
		/// Row 0, Column 1 of the Half2x2.
		/// </summary>
		[FieldOffset(2)]
		public half M01;
		...
		/// <summary>
		/// Row 1, Column 0 of the Half2x2.
		/// </summary>
		[FieldOffset(4)]
		public half M10;

		/// <summary>
		/// Row 1, Column 1 of the Half2x2.
		/// </summary>
		[FieldOffset(6)]
		public half M11;

		public static readonly Half2x2 Identity = new Half2x2(1, 0, 0, 1);
		/// <summary>
		...
		public static bool operator ==(Half2x2 left, Half2x2 right) { return left.Equals(right); }
		public static bool operator !=(Half2x2 left, Half2x2 right) { return !left.Equals(right); }
		...
		public bool Equals(Half2x2 other)
		{
