...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Int3x3: IEquatable<Int3x3>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Int3x3.
		/// </summary>
		[FieldOffset(0)]
		public int M00;

		/// <summary>
		/// Row 0, Column 1 of the Int3x3.
		/// </summary>
		[FieldOffset(4)]
		public int M01;

		/// <summary>
		/// Row 0, Column 2 of the Int3x3.
		/// </summary>
		[FieldOffset(8)]
		public int M02;
		...
		/// <summary>
		/// Row 1, Column 0 of the Int3x3.
		/// </summary>
		[FieldOffset(12)]
		public int M10;

		/// <summary>
		/// Row 1, Column 1 of the Int3x3.
		/// </summary>
		[FieldOffset(16)]
		public int M11;

		/// <summary>
		/// Row 1, Column 2 of the Int3x3.
		/// </summary>
		[FieldOffset(20)]
		public int M12;
		...
		/// <summary>
		/// Row 2, Column 0 of the Int3x3.
		/// </summary>
		[FieldOffset(24)]
		public int M20;

		/// <summary>
		/// Row 2, Column 1 of the Int3x3.
		/// </summary>
		[FieldOffset(28)]
		public int M21;

		/// <summary>
		/// Row 2, Column 2 of the Int3x3.
		/// </summary>
		[FieldOffset(32)]
		public int M22;
		...
		public static bool operator ==(Int3x3 left, Int3x3 right) { return left.Equals(right); }
		public static bool operator !=(Int3x3 left, Int3x3 right) { return !left.Equals(right); }
