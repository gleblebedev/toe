...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Int3x1: IEquatable<Int3x1>
	{

		/// <summary>
		/// Constructor of the Int3x1.
		/// </summary>
		public Int3x1(int m00, int m10, int m20 )
		{
			this.M00 = m00;
			this.M10 = m10;
			this.M20 = m20;
		...
		/// <summary>
		/// Row 2, Column 0 of the Int3x1.
		/// </summary>
		[FieldOffset(8)]
		public int M20;

		public static readonly Int3x1 Identity = new Int3x1(1, 0, 0);
		/// <summary>
		...
		public static bool operator ==(Int3x1 left, Int3x1 right) { return left.Equals(right); }
		public static bool operator !=(Int3x1 left, Int3x1 right) { return !left.Equals(right); }
		...
		public bool Equals(Int3x1 other)
		{
