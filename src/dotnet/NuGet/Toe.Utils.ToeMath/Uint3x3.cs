...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Uint3x3: IEquatable<Uint3x3>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Uint3x3.
		/// </summary>
		[FieldOffset(0)]
		public uint M00;

		/// <summary>
		/// Row 0, Column 1 of the Uint3x3.
		/// </summary>
		[FieldOffset(4)]
		public uint M01;

		/// <summary>
		/// Row 0, Column 2 of the Uint3x3.
		/// </summary>
		[FieldOffset(8)]
		public uint M02;
		...
		/// <summary>
		/// Row 1, Column 0 of the Uint3x3.
		/// </summary>
		[FieldOffset(12)]
		public uint M10;

		/// <summary>
		/// Row 1, Column 1 of the Uint3x3.
		/// </summary>
		[FieldOffset(16)]
		public uint M11;

		/// <summary>
		/// Row 1, Column 2 of the Uint3x3.
		/// </summary>
		[FieldOffset(20)]
		public uint M12;
		...
		/// <summary>
		/// Row 2, Column 0 of the Uint3x3.
		/// </summary>
		[FieldOffset(24)]
		public uint M20;

		/// <summary>
		/// Row 2, Column 1 of the Uint3x3.
		/// </summary>
		[FieldOffset(28)]
		public uint M21;

		/// <summary>
		/// Row 2, Column 2 of the Uint3x3.
		/// </summary>
		[FieldOffset(32)]
		public uint M22;
		...
		public static bool operator ==(Uint3x3 left, Uint3x3 right) { return left.Equals(right); }
		public static bool operator !=(Uint3x3 left, Uint3x3 right) { return !left.Equals(right); }
