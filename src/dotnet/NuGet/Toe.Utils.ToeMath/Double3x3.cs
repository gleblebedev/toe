...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Double3x3: IEquatable<Double3x3>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Double3x3.
		/// </summary>
		[FieldOffset(0)]
		public double M00;

		/// <summary>
		/// Row 0, Column 1 of the Double3x3.
		/// </summary>
		[FieldOffset(8)]
		public double M01;

		/// <summary>
		/// Row 0, Column 2 of the Double3x3.
		/// </summary>
		[FieldOffset(16)]
		public double M02;
		...
		/// <summary>
		/// Row 1, Column 0 of the Double3x3.
		/// </summary>
		[FieldOffset(24)]
		public double M10;

		/// <summary>
		/// Row 1, Column 1 of the Double3x3.
		/// </summary>
		[FieldOffset(32)]
		public double M11;

		/// <summary>
		/// Row 1, Column 2 of the Double3x3.
		/// </summary>
		[FieldOffset(40)]
		public double M12;
		...
		/// <summary>
		/// Row 2, Column 0 of the Double3x3.
		/// </summary>
		[FieldOffset(48)]
		public double M20;

		/// <summary>
		/// Row 2, Column 1 of the Double3x3.
		/// </summary>
		[FieldOffset(56)]
		public double M21;

		/// <summary>
		/// Row 2, Column 2 of the Double3x3.
		/// </summary>
		[FieldOffset(64)]
		public double M22;

		public static readonly Double3x3 Identity = new Double3x3(1, 0, 0, 0, 1, 0, 0, 0, 1);
		/// <summary>
		...
		public static bool operator ==(Double3x3 left, Double3x3 right) { return left.Equals(right); }
		public static bool operator !=(Double3x3 left, Double3x3 right) { return !left.Equals(right); }
