...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Uint4x4: IEquatable<Uint4x4>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Uint4x4.
		/// </summary>
		[FieldOffset(0)]
		public uint M00;

		/// <summary>
		/// Row 0, Column 1 of the Uint4x4.
		/// </summary>
		[FieldOffset(4)]
		public uint M01;

		/// <summary>
		/// Row 0, Column 2 of the Uint4x4.
		/// </summary>
		[FieldOffset(8)]
		public uint M02;

		/// <summary>
		/// Row 0, Column 3 of the Uint4x4.
		/// </summary>
		[FieldOffset(12)]
		public uint M03;
		...
		/// <summary>
		/// Row 1, Column 0 of the Uint4x4.
		/// </summary>
		[FieldOffset(16)]
		public uint M10;

		/// <summary>
		/// Row 1, Column 1 of the Uint4x4.
		/// </summary>
		[FieldOffset(20)]
		public uint M11;

		/// <summary>
		/// Row 1, Column 2 of the Uint4x4.
		/// </summary>
		[FieldOffset(24)]
		public uint M12;

		/// <summary>
		/// Row 1, Column 3 of the Uint4x4.
		/// </summary>
		[FieldOffset(28)]
		public uint M13;
		...
		/// <summary>
		/// Row 2, Column 0 of the Uint4x4.
		/// </summary>
		[FieldOffset(32)]
		public uint M20;

		/// <summary>
		/// Row 2, Column 1 of the Uint4x4.
		/// </summary>
		[FieldOffset(36)]
		public uint M21;

		/// <summary>
		/// Row 2, Column 2 of the Uint4x4.
		/// </summary>
		[FieldOffset(40)]
		public uint M22;

		/// <summary>
		/// Row 2, Column 3 of the Uint4x4.
		/// </summary>
		[FieldOffset(44)]
		public uint M23;
		...
		/// Row of the Uint4x4.
		/// </summary>
		public Uint4 Row3 { get { return new Uint4(this.M30, this.M31, this.M32, this.M33); } set {this.M30 = value.X;this.M31 = value.Y;this.M32 = value.Z;this.M33 = value.W;} }

		/// <summary>
		/// Row 3, Column 0 of the Uint4x4.
		/// </summary>
		[FieldOffset(48)]
		public uint M30;

		/// <summary>
		/// Row 3, Column 1 of the Uint4x4.
		/// </summary>
		[FieldOffset(52)]
		public uint M31;

		/// <summary>
		/// Row 3, Column 2 of the Uint4x4.
		/// </summary>
		[FieldOffset(56)]
		public uint M32;

		/// <summary>
		/// Row 3, Column 3 of the Uint4x4.
		/// </summary>
		[FieldOffset(60)]
		public uint M33;
		...
		public static bool operator ==(Uint4x4 left, Uint4x4 right) { return left.Equals(right); }
		public static bool operator !=(Uint4x4 left, Uint4x4 right) { return !left.Equals(right); }
