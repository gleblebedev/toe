...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Float4x3: IEquatable<Float4x3>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Float4x3.
		/// </summary>
		[FieldOffset(0)]
		public float M00;

		/// <summary>
		/// Row 0, Column 1 of the Float4x3.
		/// </summary>
		[FieldOffset(4)]
		public float M01;

		/// <summary>
		/// Row 0, Column 2 of the Float4x3.
		/// </summary>
		[FieldOffset(8)]
		public float M02;
		...
		/// <summary>
		/// Row 1, Column 0 of the Float4x3.
		/// </summary>
		[FieldOffset(12)]
		public float M10;

		/// <summary>
		/// Row 1, Column 1 of the Float4x3.
		/// </summary>
		[FieldOffset(16)]
		public float M11;

		/// <summary>
		/// Row 1, Column 2 of the Float4x3.
		/// </summary>
		[FieldOffset(20)]
		public float M12;
		...
		/// <summary>
		/// Row 2, Column 0 of the Float4x3.
		/// </summary>
		[FieldOffset(24)]
		public float M20;

		/// <summary>
		/// Row 2, Column 1 of the Float4x3.
		/// </summary>
		[FieldOffset(28)]
		public float M21;

		/// <summary>
		/// Row 2, Column 2 of the Float4x3.
		/// </summary>
		[FieldOffset(32)]
		public float M22;
		...
		/// Row of the Float4x3.
		/// </summary>
		public Float3 Row3 { get { return new Float3(this.M30, this.M31, this.M32); } set {this.M30 = value.X;this.M31 = value.Y;this.M32 = value.Z;} }

		/// <summary>
		/// Row 3, Column 0 of the Float4x3.
		/// </summary>
		[FieldOffset(36)]
		public float M30;

		/// <summary>
		/// Row 3, Column 1 of the Float4x3.
		/// </summary>
		[FieldOffset(40)]
		public float M31;

		/// <summary>
		/// Row 3, Column 2 of the Float4x3.
		/// </summary>
		[FieldOffset(44)]
		public float M32;
		...
		public static bool operator ==(Float4x3 left, Float4x3 right) { return left.Equals(right); }
		public static bool operator !=(Float4x3 left, Float4x3 right) { return !left.Equals(right); }
