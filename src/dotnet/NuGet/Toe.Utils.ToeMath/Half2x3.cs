...
namespace Toe.Utils.ToeMath
{
	...
	public struct Half2x3: IEquatable<Half2x3>
	{
		...
		/// <summary>
		/// Row 0, Column 1 of the Half2x3.
		/// </summary>
		[FieldOffset(2)]
		public half M01;

		/// <summary>
		/// Row 0, Column 2 of the Half2x3.
		/// </summary>
		[FieldOffset(4)]
		public half M02;
		...
		/// <summary>
		/// Row 1, Column 1 of the Half2x3.
		/// </summary>
		[FieldOffset(8)]
		public half M11;

		/// <summary>
		/// Row 1, Column 2 of the Half2x3.
		/// </summary>
		[FieldOffset(10)]
		public half M12;
		/// <summary>
		...
		public static bool operator ==(Half2x3 left, Half2x3 right) { return left.Equals(right); }
		public static bool operator !=(Half2x3 left, Half2x3 right) { return !left.Equals(right); }
