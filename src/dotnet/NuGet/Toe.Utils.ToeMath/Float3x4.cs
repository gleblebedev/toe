...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Float3x4: IEquatable<Float3x4>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Float3x4.
		/// </summary>
		[FieldOffset(0)]
		public float M00;

		/// <summary>
		/// Row 0, Column 1 of the Float3x4.
		/// </summary>
		[FieldOffset(4)]
		public float M01;

		/// <summary>
		/// Row 0, Column 2 of the Float3x4.
		/// </summary>
		[FieldOffset(8)]
		public float M02;

		/// <summary>
		/// Row 0, Column 3 of the Float3x4.
		/// </summary>
		[FieldOffset(12)]
		public float M03;
		...
		/// <summary>
		/// Row 1, Column 0 of the Float3x4.
		/// </summary>
		[FieldOffset(16)]
		public float M10;

		/// <summary>
		/// Row 1, Column 1 of the Float3x4.
		/// </summary>
		[FieldOffset(20)]
		public float M11;

		/// <summary>
		/// Row 1, Column 2 of the Float3x4.
		/// </summary>
		[FieldOffset(24)]
		public float M12;

		/// <summary>
		/// Row 1, Column 3 of the Float3x4.
		/// </summary>
		[FieldOffset(28)]
		public float M13;
		...
		/// <summary>
		/// Row 2, Column 0 of the Float3x4.
		/// </summary>
		[FieldOffset(32)]
		public float M20;

		/// <summary>
		/// Row 2, Column 1 of the Float3x4.
		/// </summary>
		[FieldOffset(36)]
		public float M21;

		/// <summary>
		/// Row 2, Column 2 of the Float3x4.
		/// </summary>
		[FieldOffset(40)]
		public float M22;

		/// <summary>
		/// Row 2, Column 3 of the Float3x4.
		/// </summary>
		[FieldOffset(44)]
		public float M23;
		...
		public static bool operator ==(Float3x4 left, Float3x4 right) { return left.Equals(right); }
		public static bool operator !=(Float3x4 left, Float3x4 right) { return !left.Equals(right); }
