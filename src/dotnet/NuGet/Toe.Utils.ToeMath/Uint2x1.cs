...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Uint2x1: IEquatable<Uint2x1>
	{

		/// <summary>
		/// Constructor of the Uint2x1.
		/// </summary>
		public Uint2x1(uint m00, uint m10 )
		{
			this.M00 = m00;
			this.M10 = m10;
		}
		...
		/// <summary>
		/// Row 1, Column 0 of the Uint2x1.
		/// </summary>
		[FieldOffset(4)]
		public uint M10;

		public static readonly Uint2x1 Identity = new Uint2x1(1, 0);
		/// <summary>
		...
		public static bool operator ==(Uint2x1 left, Uint2x1 right) { return left.Equals(right); }
		public static bool operator !=(Uint2x1 left, Uint2x1 right) { return !left.Equals(right); }
		...
		public bool Equals(Uint2x1 other)
		{
