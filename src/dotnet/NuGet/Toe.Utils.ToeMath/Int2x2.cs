...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Int2x2: IEquatable<Int2x2>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Int2x2.
		/// </summary>
		[FieldOffset(0)]
		public int M00;

		/// <summary>
		/// Row 0, Column 1 of the Int2x2.
		/// </summary>
		[FieldOffset(4)]
		public int M01;
		...
		/// <summary>
		/// Row 1, Column 0 of the Int2x2.
		/// </summary>
		[FieldOffset(8)]
		public int M10;

		/// <summary>
		/// Row 1, Column 1 of the Int2x2.
		/// </summary>
		[FieldOffset(12)]
		public int M11;
		...
		public static bool operator ==(Int2x2 left, Int2x2 right) { return left.Equals(right); }
		public static bool operator !=(Int2x2 left, Int2x2 right) { return !left.Equals(right); }
