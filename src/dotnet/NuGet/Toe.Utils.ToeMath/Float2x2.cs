...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Float2x2: IEquatable<Float2x2>
	{
		...
		/// <summary>
		/// Row 0, Column 0 of the Float2x2.
		/// </summary>
		[FieldOffset(0)]
		public float M00;

		/// <summary>
		/// Row 0, Column 1 of the Float2x2.
		/// </summary>
		[FieldOffset(4)]
		public float M01;
		...
		/// <summary>
		/// Row 1, Column 0 of the Float2x2.
		/// </summary>
		[FieldOffset(8)]
		public float M10;

		/// <summary>
		/// Row 1, Column 1 of the Float2x2.
		/// </summary>
		[FieldOffset(12)]
		public float M11;

		public static readonly Float2x2 Identity = new Float2x2(1, 0, 0, 1);
		/// <summary>
		...
		public static bool operator ==(Float2x2 left, Float2x2 right) { return left.Equals(right); }
		public static bool operator !=(Float2x2 left, Float2x2 right) { return !left.Equals(right); }
