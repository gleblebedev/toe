...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Double3x2: IEquatable<Double3x2>
	{
		...
		/// <summary>
		/// Row 1, Column 0 of the Double3x2.
		/// </summary>
		[FieldOffset(16)]
		public double M10;

		/// <summary>
		/// Row 1, Column 1 of the Double3x2.
		/// </summary>
		[FieldOffset(24)]
		public double M11;
		...
		/// <summary>
		/// Row 2, Column 0 of the Double3x2.
		/// </summary>
		[FieldOffset(32)]
		public double M20;

		/// <summary>
		/// Row 2, Column 1 of the Double3x2.
		/// </summary>
		[FieldOffset(40)]
		public double M21;

		public static readonly Double3x2 Identity = new Double3x2(1, 0, 0, 1, 0, 0);
		/// <summary>
		...
		public static bool operator ==(Double3x2 left, Double3x2 right) { return left.Equals(right); }
		public static bool operator !=(Double3x2 left, Double3x2 right) { return !left.Equals(right); }
