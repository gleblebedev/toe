...
namespace Toe.Utils.ToeMath
{
	...
	public partial struct Float1x3: IEquatable<Float1x3>
	{

		/// <summary>
		/// Constructor of the Float1x3.
		/// </summary>
		public Float1x3(float m00, float m01, float m02 )
		{
			this.M00 = m00;
			this.M01 = m01;
			this.M02 = m02;
		...
		/// <summary>
		/// Row 0, Column 0 of the Float1x3.
		/// </summary>
		[FieldOffset(0)]
		public float M00;

		/// <summary>
		/// Row 0, Column 1 of the Float1x3.
		/// </summary>
		[FieldOffset(4)]
		public float M01;

		/// <summary>
		/// Row 0, Column 2 of the Float1x3.
		/// </summary>
		[FieldOffset(8)]
		public float M02;

		public static readonly Float1x3 Identity = new Float1x3(1, 0, 0);
		/// <summary>
		...
		public static bool operator ==(Float1x3 left, Float1x3 right) { return left.Equals(right); }
		public static bool operator !=(Float1x3 left, Float1x3 right) { return !left.Equals(right); }
		...
		public bool Equals(Float1x3 other)
		{
