...
namespace Toe.Messaging.Types
{
	...
	public struct Vector4 : IEquatable<Vector4>
	{
		...
		public float LengthFast
		{
			get
			{
				return 1.0f / MathHelper.InverseSqrtFast(this.X * this.X + this.Y * this.Y + this.Z * this.Z + this.W * this.W);
			}
		}
		...
		{
			float scale = MathHelper.InverseSqrtFast(this.X * this.X + this.Y * this.Y + this.Z * this.Z + this.W * this.W);
			this.X *= scale;
			this.Y *= scale;
			this.Z *= scale;
			this.W *= scale;
