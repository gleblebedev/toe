...
namespace Toe.Messaging.Types
{
	...
	public struct Vector3 : IEquatable<Vector3>
	{
		...
		public float LengthFast
		{
			get
			{
				return 1.0f / MathHelper.InverseSqrtFast(this.X * this.X + this.Y * this.Y + this.Z * this.Z);
			}
		}
		...
		public void NormalizeFast()
		{
			...
			item.Single = this.X * this.X + this.Y * this.Y + this.Z * this.Z;
			...
			float scale = item.Single * (1.5f - xhalf * item.Single * item.Single); // Perform left single Newton-Raphson step.
