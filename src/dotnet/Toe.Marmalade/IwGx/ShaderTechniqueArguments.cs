...
namespace Toe.Marmalade.IwGx
{
	public class ShaderTechniqueArguments
	{
		...
		/// </summary>
		public OpenTK.Matrix4 inPMVMat = Matrix4.Identity;

		/// <summary>
		/// Model-view matrix. The transform to view space. 
		/// </summary>
		public OpenTK.Matrix4 inMVMat = Matrix4.Identity;
		...
		/// </summary>
		public OpenTK.Matrix4 inMVRotMat = Matrix4.Identity;
		...
		/// Alpha test value. 
		/// </summary>
		public float inAlphaTestValue = 0;
