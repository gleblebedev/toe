...
{
	internal class VerticalStackPanelLayout : LayoutEngine
	{

		// Singleton instance shared by all FlowPanels. 
		internal static readonly VerticalStackPanelLayout Instance = new VerticalStackPanelLayout();
...
//            Size prefSize = this.xLayout(container, measureBounds, /* measureOnly = */ true);
...
//                prefSize = this.xLayout(container, measureBounds, /* measureOnly = */ true);
//            }
...
//                rowSize = this.MeasureRow(containerProxy, elementProxy, i, measureBounds, out breakIndex);
...
//                        rowSize.Width,
//                        rowSize.Height);
//                    this.LayoutRow(containerProxy, elementProxy, /* startIndex = */ i, /* endIndex = */ breakIndex, rowBounds);
//                }
...
//            {
//                this.Debug_VerifyAlignment(container, flowDirection);
//            }
...
//        {
//            int dummy;
//            Size outSize = this.xLayoutRow(containerProxy, elementProxy, startIndex, endIndex, rowBounds, /* breakIndex = */ out dummy, /* measureOnly = */ false);
...
//        {
//            return this.xLayoutRow(containerProxy, elementProxy, startIndex, /* endIndex = */ containerProxy.Container.Children.Count, displayRectangle, out breakIndex, /* measureOnly = */ true);
//        }
...
//                        FlowLayoutPanel flp = this.Container as FlowLayoutPanel;
//                        if (flp != null)
//                        {
...
//            {
//                get { return this._isContainerRTL; }
//            }
...
//                    {
//                        this._elementProxy = (this.IsVertical) ? new VerticalElementProxy() : new ElementProxy();
//                    }
...
//                newBounds.X = this.DisplayRect.Right - bounds.X - bounds.Width + this.ElementProxy.Margin.Left - this.ElementProxy.Margin.Right;
...
//                    base.Bounds = this.RTLTranslateNoMarginSwap(value);
//                }
//            }
//        }
...
//                get
//                {
//                    AnchorStyles anchorStyles = LayoutUtils.GetUnifiedAnchor(this.Element);
...
//            {
//                get { return CommonProperties.GetAutoSize(this._element); }
//            }

//            public virtual Rectangle Bounds
//            {
//                set { this._element.SetBounds(value, BoundsSpecified.None); }
//            }
...
//                {
//                    this._element = value;
//                    Debug.Assert(this.Element == value, "Element should be the same as we set it to");
//                }
//            }
...
//                get
//                {
//                    AnchorStyles styles = this.AnchorStyles;
...
//            {
//                get { return CommonProperties.GetMargin(this.Element); }
//            }

//            public virtual Size MinimumSize
//            {
//                get { return CommonProperties.GetMinimumSize(this.Element, Size.Empty); }
//            }

//            public bool ParticipatesInLayout
//            {
//                get { return this._element.ParticipatesInLayout; }
//            }

//            public virtual Size SpecifiedSize
//            {
//                get { return CommonProperties.GetSpecifiedBounds(this._element).Size; }
//            }
